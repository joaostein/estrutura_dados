...
// Implementar as operações inserir (OK), imprimir (OK), imprimir (OK), alterar e
// remover para uma lista encadeada formada por registros
// contendo cpf,nome e idade de pessoas usando funções em
// C. As operações referentes à lista devem ficar em uma
// biblioteca separada do programa principal.
